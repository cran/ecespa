...
getis.plot(getis.obj, type="k", interp=100, color=tim.colors(64),
...
functions in empty or sparse areas. The command \code{\link{getis.plot}}  plots the spatial distribution of  the local \eqn{K} or \eqn{L} function or other related local statistics, such as 
