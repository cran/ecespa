...
K function. For a more detailed explanation of the Method of Minimum Contrast, see \code{\link[spatstat.model]{mincontrast}}
...
\note{The exponents \eqn{p} and \eqn{q} of the contrast criterion (see \code{\link[spatstat.model]{mincontrast}}) are fixed 
...
\code{\link[spatstat.model]{mincontrast}} performs a more general implementation of the method of mimimum contrast.}
\examples{
