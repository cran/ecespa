...
\details{
  The \emph{mark-sum measure} is a smoothed summary measuring locally the contribution of points and marks. For any fixed location \eqn{x} within the 
  ...
  \eqn{R} with centre in  \eqn{x}. The \emph{point-sum measure} \eqn{ I[R](x)} is defined as the sum of points within the circle of radius \eqn{R} with centre
  ...
  near \eqn{x} and is defined as
  \deqn{ bar(S)[R](x) = S[R](x)/I[R](x)}
...
\value{
  ...
  \item{minus}{Point-sum of the grid points. For internal use only.} 
