...
"\code{\link[spatstat.geom]{im}}" of spatstat) giving the intensity values at all locations of \code{A}. } 
 \item{mod}{ A fitted model. An object of class \code{\link[spatstat.model]{ppm}}. }
...
with an inhomogeneous Poisson model fitted to the original pattern of 'live' points (with spatstat function \code{\link[spatstat.model]{ppm}}; see the examples).
